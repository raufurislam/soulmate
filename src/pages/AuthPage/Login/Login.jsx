...
const Login = () => {
  ...
  const handleDemoLogin = (role) => {
    const demoCredentials = {
      admin: { email: "raufur@gmail.com", password: "753951Bd" },
      premium: { email: "raufur30@gmail.com", password: "753951Bd" },
    };
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 lg:px-28 py-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-neutral rounded-2xl">
        {/* Image Section */}
        <div className="md:w-1/2 bg-gradient-to-b from-blue-50 to-blue-100 rounded-l-xl h-80 md:h-[580px]">
          <img
            src={loginImg}
            alt="Login"
            className="w-full h-full object-cover rounded-l-xl"
        ...
        <div className="md:w-1/2 w-full p-4 lg:p-10">
          ...
          <div className="flex gap-4 mb-5">
            <button
              ...
              className="text-text1 border border-primary hover:bg-[#E32636]/10 font-medium rounded-full text-sm px-5 py-2.5 text-center"
            >
              Login as Admin
            </button>
            <button
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="text-white mt-4 bg-primary hover:bg-[#E32636] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full px-5 py-2.5 text-center"
            >
              Login
            </button>
          </form>
