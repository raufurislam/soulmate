...
const Dashboard = () => {
  ...
  // Refresh or reset state when navigating back to home
  useEffect(() => {
    if (user && user.email) {
      // Force data refresh or reset state
      // Optionally, you can also trigger any state reset or API call here
    }
  }, [user]); // Dependency on user state to ensure re-fetching data
